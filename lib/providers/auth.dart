...
import 'package:shop_app/models/htp_exception.dart';
...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyA9OoVPtgYQvqhZIvxSvW8WjadNOIXjk6o");
    try {
